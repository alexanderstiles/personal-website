  ...
  return (
    <div className="section-padding">
      ...
      <p style={{ maxWidth: 700, margin: "auto", lineHeight: "30px" }}>
        Welcome to my website!  I'm Alex, an American expatriate who grew up in
        Europe (Scotland and Spain).  I work for Ballast Lane Applications, a
        custom software development firm in Boston.  In May I will receive my
        ...
        projects that I have worked on below!
      </p>
    </div>
  );
}
